...
## 🐞 Bug Report 1: Process File Functionality Not Working

**Summary:**
The *Process File* button is visible but clicking it does not trigger any file processing action, causing test failures.
...
## 🐞 Bug Report 2: System Does Not Support Uploading Multiple Files at Once
...
## 🐞 Bug Report 3: Certain File Types Not Accepted (.png, .docx)
...
## 🐞 Bug Report 4: Chatbot “Ask Question” Button Enabled But No Response Returned
